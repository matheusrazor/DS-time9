...
func _ready():
	...
	hide_texbox()
	text_queue("O que é um Protoboard? Placa que possui furos/conexões internas para montar circuitos, para testar eletrônicos. ")
	text_queue("Sua maior vantagem é com esse objeto não se precisa usar fogo para conectar os circuitos.")
