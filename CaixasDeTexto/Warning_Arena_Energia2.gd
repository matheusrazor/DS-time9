...
func _ready():
	...
	hide_texbox()
	text_queue("O que é uma placa solar? É um equipamento do sistema de energia solar")
	text_queue("Responsável por realizar a conversão da luz do sol em energia elétrica captando os raios ultravioleta.")
	text_queue("Assim, fazendo os raios de sol virarem energia limpa!")
