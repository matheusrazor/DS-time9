...
func _ready():
	...
	hide_texbox()
	text_queue("O que é uma bateria recarregável? Um tipo de bateria que pode ser recarregada e usada muitas vezes sem danificar ela.")
	text_queue("Evitando das pilhas virarem lixo.")
