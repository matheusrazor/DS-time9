...
func _ready():
	...
	hide_texbox()
	text_queue("O que são transistores? Dispositivo usado em circuitos eletrônicos, aumenta a intensidade da corrente elétrica.")
	text_queue("Fundamentais na construção de dispositivos eletrônicos modernos, como chips de computadores e smartphones, por exemplo.")
	text_queue("Precisam estar no rumo do resistor para o protoboard funcionar.")
