...
func _ready():
	...
	hide_texbox()
	text_queue("O que é erro de compilação: Ocorrem quando o programa que escrevemos não obedece às regras da linguagem da máquina.")
	text_queue("Os mais frequentes, como por exemplo, pode ser esquecer um ponto e vírgula.")
