...
func _ready():
	...
	hide_texbox()
	text_queue("O que é energia limpa? Toda aquela eletricidade gerada sem a emissão de poluição ou impactos ao meio ambiente.")
	text_queue("Atualmente, as maiores representantes desse tipo de geração são as energias solar e eólica.")
