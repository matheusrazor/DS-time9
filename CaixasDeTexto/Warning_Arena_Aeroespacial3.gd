...
func _ready():
	...
	hide_texbox()
	text_queue("O que é um túnel de vento? É uma instalação que tem por objetivo simular para estudos o efeito do movimento de ar...")
	text_queue("Sobre ou ao redor de objetos sólidos.")
